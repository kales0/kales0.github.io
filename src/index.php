		...
		<div class="timeline">
			...
			<div class="timeline-section right">
				<div class="company-bio">
					...
					<div>2019</div>
					<div>Payment gateway service with integrations for commonly used checkout carts.  I was hired to move the product beyond the prototype stage and get the team established.  We had significant growth in the year I was working there.</div>
				</div>
			...
			<div class="timeline-section left">
				<div class="company-bio">
					...
					<div>2018</div>
					<div>Law tools and services for collaboration, knowledge capture, organization, and document assembly.</div>
				</div>
			...
			<div class="timeline-section right">
				<div class="company-bio">
					...
					<div>Software agency, digital design & development studio.  Wide range of clients. Largly medical industry projects as well as work for government agencies.  Planned and produced more then 35 software products from concept to production.</div>
				</div>
			...
			<div class="timeline-section left">
				<div class="company-bio">
					...
					<div>2011</div>
					<div>Developed a blackberry application for the Center for Development of Open Technology.  Interactive training materials prepared for the Center for Academic Excellence.</div>
				</div>
			...
			<div class="timeline-section right">
				<div class="company-bio">
					...
					<div>Software Developer</div>
					<div>2009</div>
					<div>Book printing company, worked in I.T. migrating data and code from old systems to newer web technologies and languages.</div>
				</div>
			...
			<div class="timeline-section left">
				<div class="company-bio">
					...
					<div>Software Developer</div>
					<div>2007</div>
					<div>Prepared internal tools for administration as part of the I.T. team.</div>
				</div>
